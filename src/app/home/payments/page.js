...
const payments = [
  {
    id: 1,
    icon: <ArrowRightIcon className="md:h-8 md:w-8 h-6 w-6 text-blue-500" />,
    Heading: "Send money",
  ...
  },
  {
    id: 2,
    icon: (
      <DevicePhoneMobileIcon className="md:h-8 md:w-8 h-6 w-6 text-blue-500" />
    ),
  ...
  {
    id: 3,
    icon: <BanknotesIcon className="md:h-8 md:w-8 h-6 w-6 text-blue-500" />,
  ...
  {
    id: 4,
    icon: <ArrowLeftIcon className="md:h-8 md:w-8 h-6 w-6 text-blue-500" />,
  ...
  {
    id: 5,
    icon: <GiScubaTanks className="md:h-8 md:w-8 h-6 w-6 text-blue-500" />,
  ...
  {
    id: 6,
    icon: <QrCodeIcon className="md:h-8 md:w-8 h-6 w-6 text-blue-500" />,
    Heading: "QR payments",
        ...
        {payments.map((payment) => {
          return (
            <div
              ...
              className="dark:bg-gray-900 cursor-pointer bg-gray-300 w-full md:h-56  flex dark:hover:bg-gray-800 hover:bg-gray-200 pt-4 pb-2 space-x-4 px-2 md:px-0 md:flex-col flex-row items-center md:space-y-3 "
            >
              ...
              <div className="flex md:flex-col flex-row space-x-4 md:space-x-0 w-full md:w-auto justify-between   items-center md:space-y-3 ">
                <div className="flex flex-col md:items-center md:space-y-3 space-y-1">
                  <div className="font-bold md:text-2xl">{payment.Heading}</div>
