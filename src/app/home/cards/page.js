...
const MyCards = [
  {
    id: 1,
    icon: (
      <MdOutlineCreditCard className="h-8 w-8 min-[2560px]:w-14 min-[2560px]:h-14 text-blue-500" />
    ),
  ...
  },
  {
    id: 2,
    icon: (
      <MdAddCard className="h-8 w-8 min-[2560px]:w-14 min-[2560px]:h-14 text-blue-500" />
    ),
  ...
  },
  {
    id: 3,
    icon: (
      <MdOutlineCreditCardOff className="h-8 w-8 min-[2560px]:w-14 min-[2560px]:h-14 text-blue-500" />
    ),
        ...
        {MyCards.map((Card) => {
          return (
            <Link key={Card.id} href={Card.url}>
              <div className="dark:bg-gray-900 bg-gray-300 w-full md:h-56 min-[2560px]:h-[600px]  flex dark:hover:bg-gray-800 hover:bg-gray-200 min-[2560px]:pt-20  pt-4 pb-2 space-x-4 px-2 md:px-0 md:flex-col flex-row items-center md:space-y-3 min-[2560px]:space-y-[80px] ">
                ...
                <div className="flex md:flex-col flex-row space-x-4 md:space-x-0 w-full md:w-auto justify-between   items-center md:space-y-3 min-[2560px]:space-y-[80px]">
                  <div className="flex flex-col md:items-center md:space-y-3 min-[2560px]:space-y-[80px] space-y-1">
                    ...
                    <div className=" opacity-80 text-sm md:text-md min-[2560px]:text-2xl">
                      {Card.Body}
                    </div>
                  </div>
