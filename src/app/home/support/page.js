...
const Supports = [
  {
    id: 1,
    icon: (
      <IoIosPerson className="md:h-8 min-[2560px]:w-14 min-[2560px]:h-14 md:w-8 h-6 w-6 text-blue-500" />
    ),
  ...
  },
  {
    id: 2,
    icon: (
      <BiChat className="md:h-8 min-[2560px]:w-14 min-[2560px]:h-14 md:w-8 h-6 w-6 text-blue-500" />
    ),
    Heading: "Live chat",
    ModalText: "Live chat",
  },
  {
    id: 3,
    icon: (
      <AiOutlineQuestionCircle className="md:h-8 min-[2560px]:w-14 min-[2560px]:h-14 md:w-8 h-6 w-6 text-blue-500" />
    ),
    Heading: "FAQ",
    ModalText: "FAQ",
  },
  {
    id: 4,
    icon: (
      <MdFeedback className="md:h-8 min-[2560px]:w-14 min-[2560px]:h-14 md:w-8 h-6 w-6 text-blue-500" />
    ),
  ...
  },
  {
    id: 5,
    icon: (
      <MdReportGmailerrorred className="md:h-8 min-[2560px]:w-14 min-[2560px]:h-14 md:w-8 h-6 w-6 text-blue-500" />
    ),
...
const Socials = [
  {
    id: 1,
    icon: (
      <BsTwitter className="md:h-8 min-[2560px]:w-14 min-[2560px]:h-14 md:w-8 h-6 w-6 text-blue-500" />
    ),
  ...
  },
  {
    id: 2,
    icon: (
      <BsFacebook className="md:h-8 min-[2560px]:w-14 min-[2560px]:h-14 md:w-8 h-6 w-6 text-blue-500" />
    ),
    Heading: "FocusBankNig",
  },
  {
    id: 3,
    icon: (
      <BsInstagram className="md:h-8 min-[2560px]:w-14 min-[2560px]:h-14 md:w-8 h-6 w-6 text-blue-500" />
    ),
    Heading: "@FocusBankNig",
  },
];
const Support = () => {
  ...
  const { username } = useContext(FocusContext); //using  user email logic from custom hook with its states being managed in the context
  ...
  return (
    <>
      <div className="overflow-y-scroll">
        <div className="px-6 pt-6 md:font-extrabold font-bold text-sm min-[2560px]:text-3xl  md:text-2xl">
          {myGreeting},
          <span className="font-bold min-[2560px]:text-3xl opacity-80">
            {username}
          </span>
        </div>
        <div className="px-6  hidden md:block md:justify-center pb-6 pt-4 opacity-90 font-bold md:text-xl">
          <div className="text-center min-[2560px]:text-3xl">Support</div>
        </div>
            ...
            {Supports.map((Support) => {
              return (
                <div
                  ...
                  className="dark:bg-gray-900 bg-gray-300 w-full md:h-56 min-[2560px]:h-[600px]  cursor-pointer  flex dark:hover:bg-gray-800 hover:bg-gray-200 pt-4 pb-2 space-x-4 px-2 md:px-0 md:flex-col flex-row md:justify-evenly items-center md:space-y-3  "
                >
                  ...
                  <div className="flex md:flex-col flex-row space-x-4 md:space-x-0 w-full md:w-auto justify-between   items-center md:space-y-3 min-[2560px]:space-y-[120px] ">
                    <div className="flex flex-col md:items-center md:space-y-3 space-y-1">
                      <div className="font-bold md:text-2xl min-[2560px]:text-3xl">
                        {Support.Heading}
                      </div>
                    </div>
        ...
        <div className="px-6  hidden md:block justify-center pb-6 pt-4 opacity-90 font-bold text-xl">
          <div className="text-center min-[2560px]:text-3xl">Social Media</div>
        </div>
        <div className="px-6 mt-6 md:mt-0">
          <div className=" md:grid md:grid-cols-2 flex flex-col md:bg-transparent md:dark:bg-transparent dark:bg-gray-900 bg-gray-300  md:gap-4  md:py-14 md:pt-4      md:pb-10 pb-2  ">
            <div className="px-3 md:hidden flex md:justify-center pb-1 pt-2 opacity-90 font-bold md:text-xl">
            ...
            {Socials.map((Social) => {
              return (
                <div
                  key={Social.id}
                  className="dark:bg-gray-900 bg-gray-300 w-full md:h-56 min-[2560px]:h-[600px]  flex dark:hover:bg-gray-800 hover:bg-gray-200 pt-4 pb-2 space-x-4 px-2 md:px-0 md:flex-col flex-row md:justify-evenly items-center md:space-y-3 "
                >
                  <div className="md:py-3 md:px-3 px-1 py-1 dark:bg-gray-950 bg-gray-400">
                    {Social.icon}
                  </div>
                  ...
                  <div className="flex md:flex-col flex-row space-x-4 md:space-x-0 w-full md:w-auto justify-between   items-center md:space-y-3 ">
                    <div className="flex flex-col md:items-center md:space-y-3 space-y-1">
                      <div className="font-bold min-[2560px]:text-3xl md:text-2xl">
                        {Social.Heading}
                      </div>
                    </div>
                  </div>
        ...
        <div className="border-t-[0.1px] pt-10 hidden md:block  dark:border-gray-800 border-gray-400 mx-6"></div>
        <div className="px-6  hidden md:block justify-center   pb-6 pt-4 opacity-90 font-bold text-xl">
          <div className="text-center min-[2560px]:text-3xl">Email Us</div>
        </div>
        ...
        <div className="px-6 mt-6 md:mt-0 mb-20">
          <div className=" md:grid md:grid-cols-1 flex flex-col md:bg-transparent md:dark:bg-transparent dark:bg-gray-900 bg-gray-300  md:gap-4  md:py-14 md:pt-4      md:pb-10 pb-2  ">
            ...
            <div className="dark:bg-gray-900 bg-gray-300 w-full md:h-40  flex dark:hover:bg-gray-800 hover:bg-gray-200 pt-4 pb-2 space-x-4 px-2 md:px-0 md:flex-col flex-row md:justify-evenly items-center md:space-y-3 ">
              <div className="md:py-3 md:px-3 px-1 py-1 dark:bg-gray-950 bg-gray-400">
                <AiOutlineMail className="h-8 w-8 min-[2560px]:w-14 min-[2560px]:h-14 text-blue-500" />
              </div>

              <div className="flex md:flex-col flex-row space-x-4 md:space-x-0 w-full md:w-auto justify-between   items-center md:space-y-3  ">
                <div className="flex flex-col md:items-center md:space-y-3 space-y-1">
                  <div className="font-bold text-sm min-[2560px]:text-3xl md:text-2xl">
